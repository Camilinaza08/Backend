...
public enum ClasificacionEsrb {
     ...
     */
    public static ClasificacionEsrb fromCodigo(String nombre) {
    if (nombre == null || nombre.isBlank()) {
        return UR; // Valor por defecto para no definido
    }
    ...
    throw new IllegalArgumentException("Código ESRB inválido: " + nombre);
}
}
